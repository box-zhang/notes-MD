...
![img](https://user-gold-cdn.xitu.io/2019/2/27/1692e385403c39ab?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
![img](https://user-gold-cdn.xitu.io/2019/2/27/1692e4211a8fec55?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
![img](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1008" height="452"></svg>)



- 客户端发送一个带 SYN=1，Seq=X 的数据包到服务器端口`（第一次握手，由浏览器发起，告诉服务器我要发送请求了）`
- 服务器发回一个带 SYN=1， ACK=X+1， Seq=Y 的响应包以示传达确认信息`（第二次握手，由服务器发起，告诉浏览器我准备接受了，你赶紧发送吧。其中ACK报文是用来应答的，SYN报文是用来同步的。）`
...
```
为避免篇幅过长，http协议、缓存等相关内容将在后期文章中介绍
```
...
![img](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="822" height="768"></svg>)
...
![img](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="690" height="384"></svg>)
...
![img](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="624" height="289"></svg>)
...
![img](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="800" height="443"></svg>)
